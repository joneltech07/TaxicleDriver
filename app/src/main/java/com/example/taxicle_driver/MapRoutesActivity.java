...
public class MapRoutesActivity extends AppCompatActivity {
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean result) {
            if (result) {
                Toast.makeText(MapRoutesActivity.this, "Permission granted! Restart this app", Toast.LENGTH_SHORT).show();
            }
        }
    });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (ActivityCompat.checkSelfPermission(MapRoutesActivity.this, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
                activityResultLauncher.launch(Manifest.permission.POST_NOTIFICATIONS);
            }
        }

        if (ActivityCompat.checkSelfPermission(MapRoutesActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
...
//                        });
    ...
    private void fetchRoute() {
        LocationEngine locationEngine = LocationEngineProvider.getBestLocationEngine(MapRoutesActivity.this);
            ...
            public void onSuccess(LocationEngineResult result) {
                ...
                mapboxNavigation.requestRoutes(builder.build(), new NavigationRouterCallback() {
                    ...
                    public void onFailure(@NonNull List<RouterFailure> list, @NonNull RouteOptions routeOptions) {
                        setRoute.setEnabled(true);
                        setRoute.setText("Set route");
                        Toast.makeText(MapRoutesActivity.this, "Route request failed", Toast.LENGTH_SHORT).show();
                    }
